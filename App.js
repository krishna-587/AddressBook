...
// delete contact from the array
    ...
    searchByCityOrState(location) {
        return this.contacts.filter(contact => contact.address === location || contact.state === location);
    }
...
addressBook.addContact("Krishna", "Singh", "Mathura", "CityName", "UttarPradesh", "281001", "1234567890", "krishna587@gmail.com");
addressBook.addContact("Ansh", "Sharma", "Delhi", "CityName", "Delhi", "281001", "1234567890", "ansh09@gmail.com");
addressBook.addContact("Priya", "Goyal", "Agra", "CityName", "UttarPradesh", "281001", "1234567890", "priya@gmail.com");
addressBook.addContact("Arpit", "Jain", "Noida", "CityName", "UttarPradesh", "281001", "1234567890", "arpitJain12@gmail.com");
addressBook.addContact("Nitin", "Yadav", "Gurugram", "CityName", "Haryana", "281001", "1234567890", "nitinyadav@gmail.com");
console.log(JSON.stringify(addressBook.contacts));
console.log();

addressBook.findAndEditContact("Ansh",{city: "Gaziabad", phone: "9876543210"});
console.log(JSON.stringify(addressBook.contacts,null,2));

addressBook.findAndDeleteContact("Priya");
console.log(JSON.stringify(addressBook.contacts,null,2));
...
console.log("Contacts in StateName:", addressBook.searchByCityOrState("Delhi"));
